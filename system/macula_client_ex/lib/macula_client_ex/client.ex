defmodule MaculaClientEx.Client do
  ...
  This module provides a drop-in replacement for MaculaSdk.Wamp.Client:
      ...
      # New HTTP/3 code:
      {:ok, client} = MaculaClientEx.Client.start_link(
  ...
  ## Examples
      ...
      MaculaClientEx.Client.publish(client, "be.cortexiq.simulation.time_advanced", [], %{
        simulation_time: ~U[2025-06-15 14:32:00Z],
        speed: 105_120
      })

      # With options
      MaculaClientEx.Client.publish(client, "my.topic", [], %{data: "value"}, %{qos: 1})
  """
  ...
  ## Examples
      ...
      MaculaClientEx.Client.subscribe(client, "be.cortexiq.simulation.time_advanced", fn topic, event_data ->
  ...
  ## Examples
      ...
      MaculaClientEx.Client.register(client, "my.app.get_user", fn _args, kwargs, _details ->
  ...
  ## Examples
      ...
      {:ok, result} = MaculaClientEx.Client.call(client, "my.app.get_user", [], %{user_id: "123"})
  """
  ...
  def init(opts) do
    ...
    case :macula_sdk.connect(erl_url, erl_opts) do
      {:ok, client_pid} ->
        Logger.info("MaculaClientEx.Client connected to #{url} realm #{realm}")
      ...
      {:error, reason} ->
        Logger.error("MaculaClientEx.Client failed to connect: #{inspect(reason)}")
