defmodule CortexIqDashboard.EventSubscribers.ContractSwitchedSubscriber do
  @moduledoc """
  Vertical slice subscriber for market.contract_switched events.

  Subscribes to: be.cortexiq.market.contract_switched
  Broadcasts to: dashboard:contract_event with :switched type
  """
  use GenServer
  require Logger
  ...
  def handle_info({:event, event_data}, state) do
    ...
    Logger.info("#{__MODULE__}: Received contract switched event")
