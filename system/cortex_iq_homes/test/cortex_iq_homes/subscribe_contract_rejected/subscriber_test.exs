defmodule CortexIqHomes.SubscribeContractRejected.SubscriberTest do
  use ExUnit.Case, async: true

  alias CortexIqHomes.SubscribeContractRejected.Subscriber
  ...
  describe "handle_info/2 with :event" do
    test "processes contract rejected event" do
