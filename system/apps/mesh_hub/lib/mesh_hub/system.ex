defmodule MeshHub.System do
  @moduledoc """
  Top-level supervisor for the MeshHub system.
  ...
  defp initiate_shutdown(reason) do
    ...
    Task.start(fn ->
      ...
      Process.sleep(100)
      Logger.warning("Calling Application.stop(:mesh_hub)...")
      result = Application.stop(:mesh_hub)
  ...
  Call this from IEx: MeshHub.System.shutdown()
  """
  def shutdown do
