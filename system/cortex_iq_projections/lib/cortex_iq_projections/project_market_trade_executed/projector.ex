defmodule CortexIqProjections.ProjectMarketTradeExecuted.Projector do
  @moduledoc """
  GenServer projector for be.cortexiq.market.trade_executed events.
  ...
  @impl true
  def init(_opts) do
    Logger.info("ProjectMarketTradeExecuted.Projector: Started")
    {:ok, %{}}
  end

  @impl true
  def handle_cast({:project, event_data}, state) do
    project_market_trade_executed(event_data)
    {:noreply, state}
  end
