defmodule CortexIqProjections.ProjectBalanceUpdated.System do
  @moduledoc """
  Supervises the complete vertical slice for projecting balance.updated events.
  ...
  def init(opts) do
    ...
    wamp_client_name = :wamp_project_balance_updated

    Logger.info("ProjectBalanceUpdated.System starting")
    ...
    children = [
      ...
      # 2. Subscriber
      {CortexIqProjections.ProjectBalanceUpdated.Subscriber, [
        wamp_client: wamp_client_name
      ]},

      # 3. GenServer Projector
      {CortexIqProjections.ProjectBalanceUpdated.Projector, []}
    ]
