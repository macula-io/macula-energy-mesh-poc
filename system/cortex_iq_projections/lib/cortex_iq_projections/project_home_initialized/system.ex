defmodule CortexIqProjections.ProjectHomeInitialized.System do
  @moduledoc """
  Supervises the complete vertical slice for projecting home.initialized events.
  ...
  def init(opts) do
    ...
    wamp_client_name = :wamp_project_home_initialized

    Logger.info("ProjectHomeInitialized.System starting")
    ...
    children = [
      ...
      # 2. Subscriber
      {CortexIqProjections.ProjectHomeInitialized.Subscriber, [
        wamp_client: wamp_client_name
      ]},

      # 3. GenServer Projector
      {CortexIqProjections.ProjectHomeInitialized.Projector, []}
    ]
