defmodule CortexIqProjections.ProjectMarketSpotPriceUpdated.System do
  @moduledoc """
  Supervises the complete vertical slice for projecting market.spot_price_updated events.
  ...
  def init(opts) do
    ...
    wamp_client_name = :wamp_project_market_spot_price_updated

    Logger.info("ProjectMarketSpotPriceUpdated.System starting")
    ...
    children = [
      ...
      # 2. Subscriber
      {CortexIqProjections.ProjectMarketSpotPriceUpdated.Subscriber, [
        wamp_client: wamp_client_name
      ]},

      # 3. GenServer Projector
      {CortexIqProjections.ProjectMarketSpotPriceUpdated.Projector, []}
    ]
