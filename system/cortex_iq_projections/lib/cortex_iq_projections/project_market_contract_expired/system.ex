defmodule CortexIqProjections.ProjectMarketContractExpired.System do
  @moduledoc """
  Supervises the complete vertical slice for projecting market.contract_expired events.
  ...
  def init(opts) do
    ...
    wamp_client_name = :wamp_project_market_contract_expired

    Logger.info("ProjectMarketContractExpired.System starting")
    ...
    children = [
      ...
      # 2. Subscriber
      {CortexIqProjections.ProjectMarketContractExpired.Subscriber, [
        wamp_client: wamp_client_name
      ]},

      # 3. GenServer Projector
      {CortexIqProjections.ProjectMarketContractExpired.Projector, []}
    ]
