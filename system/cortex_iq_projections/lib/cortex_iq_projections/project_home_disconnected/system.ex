defmodule CortexIqProjections.ProjectHomeDisconnected.System do
  @moduledoc """
  Supervises the complete vertical slice for projecting home.disconnected events.
  ...
  def init(opts) do
    ...
    wamp_client_name = :wamp_project_home_disconnected

    Logger.info("ProjectHomeDisconnected.System starting")
    ...
    children = [
      ...
      # 2. Subscriber
      {CortexIqProjections.ProjectHomeDisconnected.Subscriber, [
        wamp_client: wamp_client_name
      ]},

      # 3. GenServer Projector
      {CortexIqProjections.ProjectHomeDisconnected.Projector, []}
    ]
