defmodule CortexIqProjections.ProjectHomeConnected.System do
  @moduledoc """
  Supervises the complete vertical slice for projecting home.connected events.
  ...
  def init(opts) do
    ...
    wamp_client_name = :wamp_project_home_connected

    Logger.info("ProjectHomeConnected.System starting")
    ...
    children = [
      ...
      # 2. Subscriber
      {CortexIqProjections.ProjectHomeConnected.Subscriber, [
        wamp_client: wamp_client_name
      ]},

      # 3. GenServer Projector
      {CortexIqProjections.ProjectHomeConnected.Projector, []}
    ]
