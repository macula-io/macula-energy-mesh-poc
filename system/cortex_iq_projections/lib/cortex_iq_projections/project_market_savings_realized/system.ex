defmodule CortexIqProjections.ProjectMarketSavingsRealized.System do
  @moduledoc """
  Supervises the complete vertical slice for projecting market.savings_realized events.
  ...
  def init(opts) do
    ...
    wamp_client_name = :wamp_project_market_savings_realized

    Logger.info("ProjectMarketSavingsRealized.System starting")
    ...
    children = [
      ...
      # 2. Subscriber
      {CortexIqProjections.ProjectMarketSavingsRealized.Subscriber, [
        wamp_client: wamp_client_name
      ]},

      # 3. GenServer Projector
      {CortexIqProjections.ProjectMarketSavingsRealized.Projector, []}
    ]
