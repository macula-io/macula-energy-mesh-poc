defmodule CortexIqProjections.ProjectMarketContractRejected.Projector do
  @moduledoc """
  GenServer projector for be.cortexiq.market.contract_rejected events.
  ...
  @impl true
  def init(_opts) do
    Logger.info("ProjectMarketContractRejected.Projector: Started")
    {:ok, %{}}
  end

  @impl true
  def handle_cast({:project, event_data}, state) do
    project_market_contract_rejected(event_data)
    {:noreply, state}
  end
